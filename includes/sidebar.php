<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="views/student/students.view.php">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="views/town_city/towns.view.php">
        <i class="bi bi-person"></i>
        <span>Town</span>
      </a>
    </li><!-- End Town Page Nav -->

    <li class="nav-item">
      <a class="nav-link collapsed" href="views/province/province.view.php">
        <i class="bi bi-person"></i>
        <span>Province</span>
      </a>
    </li><!-- End Province Page Nav -->
