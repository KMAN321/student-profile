<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="../student/students.view.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="town_city.view.php">
        <i class="bi bi-person"></i>
        <span>Town</span>
      </a>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="../province/province.view.php">
        <i class="bi bi-person"></i>
        <span>Province</span>
      </a>
