...
<body>
    ...
    <main id="main" class="main">
        <div class="content">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title" style="font-size: 40px;">Add Province</h1>
                    <form action="" method="post" class="row g-3">
                        <!-- Province Name -->
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Province Name" required>
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                <a href="province.view.php" class="btn btn-info">Cancel</a>
                                <button type="reset" class="btn btn-secondary">
                                    <a href="province_add.php" style="text-decoration: none; color: inherit;">Reset</a>
                                </button>
