    ...
    <main id="main" class="main">
        <div class="content">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                |
                                <a href="town_delete.php?id=<?php echo $result['id']; ?>" onclick="return confirm('Are you sure you want to delete this town/city?')">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
            ...
            <button class="btn btn-primary">
                <a href="town_add.php" style="text-decoration: none; color: inherit;">Add Town/City</a>
            </button>
